...
import { faBlog, faMailBulk } from "@fortawesome/free-solid-svg-icons";
...
import TypingText from "../components/homepage/styles/Typetext";
...
const Homepage = () => {
	...
	const [oldLogoSize, setOldLogoSize] = useState(150);
	...
	useEffect(() => {
		const handleScroll = () => {
			...
			let newLogoSize = 150 - (scroll * 4) / 10;
